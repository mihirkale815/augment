...
allennlp train -s saved_models/thclean.en.syn_en_th.syn_th_en.weather training_configs/th_master.weather.jsonnet --include-package augment.dataset_readers
